...
def load_data(sett, n_fold=20, start_fold=19, missing_value='drop', do_one_hot=True, numpy=True):
    ...
    # handle missing value in different ways
    # current used: mean
    ...
    # convert categorical feats to one hot
    if do_one_hot:
    ...
    if sett == "train":
        ...
        # divide data into n_fold splits by hand
        one_fold = data_whole.shape[0] // n_fold
        
        # get index for train and valid
